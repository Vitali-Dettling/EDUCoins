...
public class HttpProxyPeerGroup implements IProxyPeerGroup {
    ...
    /**
     * If set, {@link #receiveBlocks(Sha256Hash)} will recurse if no blocks were received.
     */
    ...
    public void receiveBlocks(Sha256Hash from) {
        ...
        for (RemoteProxy proxy : getHighestRatedProxies()) {
            try {
                ...
                //TODO: parallel? -> No, because the verification needs the block in a specific order, beginning from the genesis block.
