...
public class TransactionTest {
			...
			// approvals = 0;
	@Test
	public void whichTransactionCoinbaseTest() {
	...
	public void whichTransactionApprovalWithoutOutputTest() {
		...
		assertEquals(testee, ETransaction.APPROVED);
			...
			// approvals > 0
	@Test	//Test with: output > 0
	public void whichTransactionApprovalWithOutputTest() {
		...
		assertEquals(testee, ETransaction.APPROVED);
			...
			// approvals = 0;
	@Test
	public void whichTransactionRegularTest() {
